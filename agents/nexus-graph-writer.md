...
You receive a slice of source artifacts and a category. You produce a graph file at `~/.claude/relentless-inception/runs/<run_id>/cycle-<N>/graphs/<category>.json` in the shape:
